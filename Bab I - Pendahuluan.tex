...
Berdasarkan kondisi kualitas udara di DKI Jakarta serta ruang pengembangan pada literatur terdahulu, penelitian Tugas Akhir ini bertujuan untuk menguji model hibrida \textit{Random Forest}-ARIMA untuk prediksi harian PM\textsubscript{10}. Model ini dikonstruksi dengan memanfaatkan teknik \textit{feature engineering} guna mengeksplorasi hubungan temporal dan interaksi polutan pada dataset kualitas udara Jakarta periode tahun 2010--2025. Selanjutnya, model prediksi dianalisis menggunakan metode SHAP untuk memberikan gambaran mengenai kontribusi fitur prediktor \autocite{lundberg2025shap}. Melalui pengujian pendekatan ini, diharapkan penelitian ini dapat memberikan analisis komparatif estimasi kualitas udara yang dapat ditelaah secara sistematis sebagai materi pertimbangan dalam pengelolaan lingkungan.
