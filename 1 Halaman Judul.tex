...
\begin{center}
    ...
    {\Large\bfseries Analisis dan Evaluasi Prediksi Harian $\text{PM}_{10}$ Jakarta Menggunakan Model Hibrida Random Forest Regresi-ARIMA Berbasis Rekayasa Fitur}
