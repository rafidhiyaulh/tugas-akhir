...
\begin{center}
   \textbf{Analisis dan Evaluasi Prediksi Harian $\text{PM}_{10}$ Jakarta Menggunakan Model Hibrida Random Forest Regresi-ARIMA Berbasis Rekayasa Fitur} \\
   \vspace{0.4cm}
   oleh \\
   \vspace{0.4cm}
